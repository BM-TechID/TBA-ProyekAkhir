...
<head>
	...
	<link rel="icon" href="<?php echo base_url('assets/img/logo-ittp.png'); ?>">
		...
		<div class="row baris-utama">
			...
			<div class="col-sm-8 kotak-login clearfix">
				...
				<div class="gambar-login">
					<p>Selamat <br><b>datang<font color="ffc000"> Browww.</font></b></p>
				</div>
				<!-- Kolom Gambar Selamat Datang -->
				
				<!-- Form Login -->
				<div class="login-form">
					<img src="<?php echo base_url('assets/img/logo-ittp.png'); ?>">
